...
To install with [npm](http://github.com/isaacs/npm):
    ...
    npm install https://github.com/saturn4er/node-struct.git
...
###set(object)
overwrite current fields by object fields

###getObject()
return fields of structure without getters and setters. Good for debug
